...
ALTER TABLE IF EXISTS whatsapp_lembrete_pagamento   DISABLE TRIGGER ALL;
ALTER TABLE IF EXISTS whatsapp_messages            DISABLE TRIGGER ALL;
ALTER TABLE IF EXISTS whatsapp_fluxo_conversa      DISABLE TRIGGER ALL;
ALTER TABLE IF EXISTS whatsapp_conversations       DISABLE TRIGGER ALL;
ALTER TABLE IF EXISTS whatsapp_connections         DISABLE TRIGGER ALL;
ALTER TABLE IF EXISTS whatsapp_sessions            DISABLE TRIGGER ALL;
...
ALTER TABLE IF EXISTS whatsapp_lembrete_pagamento   ENABLE TRIGGER ALL;
ALTER TABLE IF EXISTS whatsapp_messages            ENABLE TRIGGER ALL;
ALTER TABLE IF EXISTS whatsapp_fluxo_conversa      ENABLE TRIGGER ALL;
ALTER TABLE IF EXISTS whatsapp_conversations       ENABLE TRIGGER ALL;
ALTER TABLE IF EXISTS whatsapp_connections         ENABLE TRIGGER ALL;
ALTER TABLE IF EXISTS whatsapp_sessions            ENABLE TRIGGER ALL;
