...
public class ChamadoService {
    ...
    private boolean ehChamadoPainel(com.minhaempresa.gendaz.chamado.entity.ChamadoEntity chamado) {
        if (chamado == null) {
            return false;
        }
    ...
    private boolean ehChamadoMeuGendaz(com.minhaempresa.gendaz.chamado.entity.ChamadoEntity chamado) {
        if (chamado == null) {
            return false;
        }
        String origem = chamado.getOrigem();
