...
public class LgpdService {
    ...
    public ExcluirContaResponse encerrarConta(Long usuarioId) {
        ...
        if (usuario.getPerfil() != PerfilUsuario.DONO) {
            throw new BusinessException("Acesso negado: apenas o dono pode realizar esta acao.");
        }
    ...
    public ExcluirContaResponse excluirDadosConta(Long usuarioId) {
        ...
        // 1. Registro global de auditoria ANTES da exclusao (não será apagado pelo purge)
