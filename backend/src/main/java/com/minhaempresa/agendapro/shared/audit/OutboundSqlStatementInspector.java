package com.minhaempresa.agendapro.shared.audit;
        ...
        return StackWalker.getInstance(StackWalker.Option.RETAIN_CLASS_REFERENCE)
                .walk(frames -> frames
                        .filter(frame -> {
                            ...
                            return nome.startsWith("com.minhaempresa.agendapro.")
                                    && !nome.contains(".shared.audit.")
                                    && !nome.contains(".repository.");
                        })
                        .map(frame -> frame.getClassName().substring("com.minhaempresa.agendapro.".length()) + "#" + frame.getMethodName())
                        .findFirst()
