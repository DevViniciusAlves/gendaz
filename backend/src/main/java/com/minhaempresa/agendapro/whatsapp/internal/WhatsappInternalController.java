...
public class WhatsappInternalController {
    ...
    @PostMapping("/marcar-lembrete-enviado")
    ...
    @PutMapping("/agendamentos/{id}/confirmacao-pagamento-dono")
