...
module.exports = {
  ...
  desconectarEmpresa: async () => null,
  backendHttp: null,
  enviarMensagemEmpresa: async () => null,
  enviarMensagemParaProprioNumeroEmpresa: async () => null,
  webhookAgendamento: async () => null,
  criarSocket: async () => null,
  criarSocketComLock: async () => null,
  reiniciarEmpresa: async () => null,
  limparSessaoEmpresa: async () => null,
  getConnectionStatus: async () => null,
  sendMessage: async () => null,
  restaurarSessoesPersistidas: async () => null,
  restaurarSessoesAtivas: async () => null,
};
