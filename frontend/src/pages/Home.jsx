...
//  DESATIVADO — const WHATSAPP_LINK = 'https://wa.me/5565993360300'
...
const plans = [
  {
    nome: 'Plano Básico',
    //  DESATIVADO — subtitulo: 'WhatsApp e agenda simples',
    subtitulo: 'Agenda simples',
    preco: 'R$ 39,00/mês',
    extra: '7 dias grátis',
    descricao: 'Para organizar conversas, agenda, clientes e serviços no mesmo painel.',
    //  DESATIVADO — beneficios: ['WhatsApp interno', 'Agenda organizada', 'Cadastro de clientes', 'Cadastro de serviços', 'Confirmação de consulta', 'Cancelamento e remarcação'],
        ...
        >
          ...
          >
            <span className="hero-new-badge">
              <Sparkles size={14} />
              {/*  DESATIVADO — WhatsApp + */} agenda + gestão
            </span>
          </motion.div>
...
Com uma Assistente de IA, o sistema ajuda a reduzir tarefas repetitivas, organizar informações e deixar sua operação mais simples no dia a dia.</p>
          {/*  DESATIVADO — <p>O foco é reduzir retrabalho no WhatsApp, dar previsibilidade para os atendimentos e organizar a empresa com clareza no dia a dia.</p> */}
      ...
      <section id="suporte" className="marketing-support">
        ...
        <div className="support-grid marketing-support-grid">
          <ScrollReveal className="panel support-card premium-border" delay={0}>
            <LifeBuoy size={26} />
            <h2>Base de ajuda</h2>
            {/*  DESATIVADO — <p>Orientações rápidas para WhatsApp, agenda, clientes, pagamentos e configurações.</p> */}
          ...
          <ScrollReveal className="panel support-card premium-border" delay={80}>
            ...
            {/*  DESATIVADO — <h2>Atendimento no WhatsApp</h2> */}
      ...
      <ScrollReveal id="contato" className="contact-band premium-border" delay={0}>
        ...
        {/*  DESATIVADO — <a href={WHATSAPP_LINK} className="primary-link" target="_blank" rel="noreferrer">Entrar em contato</a> */}
