...
import { useAdminCrmData } from '../../hooks/useAdminCrmData.js'
import CrmFilters from '../crm/CrmFilters.jsx'
import AdminEmpresaCard from './crm/AdminEmpresaCard.jsx'
import AdminSendMessageModal from './crm/AdminSendMessageModal.jsx'
import AdminContactHistoryModal from './crm/AdminContactHistoryModal.jsx'
...
export default function AdminCrm() {
  const { clientes, loading, error, filtros, atualizarFiltros, limparFiltros } = useAdminCrmData()
    ...
    <section className="page crm-page">
      <div className="page-title">
        <div>
          ...
          <h1>CRM - Recuperação de Empresas</h1>
          <p>Acompanhe, segmente e recupere as empresas do Gendaz pelo risco de churn.</p>
        </div>
      </div>
        ...
        <div className="crm-content">
          {loading ? (
            ...
            <div style={{
              ...
              <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 2 }}>Nenhuma empresa encontrada</div>
              <div style={{ fontSize: 12 }}>Ajuste os filtros para recuperar mais empresas.</div>
            </div>
          ) : (
