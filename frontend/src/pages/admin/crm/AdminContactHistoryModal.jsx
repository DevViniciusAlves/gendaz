...
import { buscarHistoricoAdmin } from '../../../api/adminCrmApi.js'
...
export default function AdminContactHistoryModal({ open, onClose, cliente }) {
  ...
  useEffect(() => {
    if (open && cliente?.id) {
      setLoading(true)
      buscarHistoricoAdmin(cliente.id)
