...
import { enviarMensagemAdmin } from '../../../api/adminCrmApi.js'
...
const TEMPLATES = {
  resgate: {
    ...
    assunto: 'Estamos com saudade',
      mensagem: 'Oi {nome}! Faz um tempo que voce não entra no Gendaz. O que aconteceu? Estamos com saudade dos seus agendamentos e queremos voce de volta por aqui.',
  },
  reconexao: {
...
export default function AdminSendMessageModal({ open, onClose, cliente, template, onEnviado }) {
  ...
  async function handleEnviar() {
    ...
    try {
      ...
      const response = await enviarMensagemAdmin(cliente.id, {
        template,
        canal: 'email',
