...
export const initialData = {
  ...
  equipe: [
    ...
    { id: 2, nome: 'Bruno Pro', email: 'pro@gendaz.com', perfil: 'DONO', status: 'INATIVO', presenca: 'OFFLINE', ultimoAcesso: 'Hoje Ã s 09:40' },
  ],
  clientes: [
    ...
    { id: 2, nome: 'Nori Garden', telefone: '(65) 99922-2222', email: 'nori@email.com', observacoes: 'Cliente recorrente. Sempre pede confirmaÃ§Ã£o.', totalGasto: 469.6 },
    { id: 3, nome: 'Kaito BistrÃ´', telefone: '(65) 99933-3333', email: 'kaito@email.com', observacoes: 'Tem interesse em pacote mensal.', totalGasto: 299.8 },
    ...
    { id: 5, nome: 'Lead sem pagamento', telefone: '(65) 99955-5555', email: 'lead@email.com', observacoes: 'Ainda nÃ£o realizou pagamento.', totalGasto: 0 },
  ],
  servicos: [
    { id: 1, nome: 'Consulta', descricao: 'Atendimento completo', duracaoMinutos: 60, valor: 180, status: 'ATIVO', vendas: 18 },
    { id: 2, nome: 'Retorno', descricao: 'Acompanhamento rÃ¡pido', duracaoMinutos: 30, valor: 90, status: 'ATIVO', vendas: 11 },
    { id: 3, nome: 'AvaliaÃ§Ã£o inicial', descricao: 'Primeiro atendimento', duracaoMinutos: 45, valor: 140, status: 'ATIVO', vendas: 8 },
  ],
  profissionais: [
    { id: 1, nome: 'Dra. Marina', especialidade: 'ClÃ­nica geral', telefone: '(65) 98888-1111', status: 'ATIVO' },
  ...
  agendamentos: [
    ...
    { id: 2, clienteId: 2, clienteNome: 'Nori Garden', servicoId: 2, servicoNome: 'Retorno', profissionalId: 2, profissionalNome: 'Dr. Rafael', data: '2026-06-16', horaInicio: '14:00', horaFim: '14:30', status: 'PENDENTE', observacoes: 'Aguardando confirmaÃ§Ã£o.' },
    { id: 3, clienteId: 3, clienteNome: 'Kaito BistrÃ´', servicoId: 3, servicoNome: 'AvaliaÃ§Ã£o inicial', profissionalId: 1, profissionalNome: 'Dra. Marina', data: '2026-06-17', horaInicio: '10:30', horaFim: '11:15', status: 'FINALIZADO', observacoes: 'Gerou pagamento.' },
  ...
  conversas: [
    ...
    { id: 3, clienteId: 3, clienteNome: 'Kaito BistrÃ´', clienteTelefone: '(65) 99933-3333', status: 'ABERTA', ultimaMensagem: 'Tem horÃ¡rio amanhÃ£?', dataUltimaMensagem: '2026-06-15T17:20:00' },
  ],
  mensagens: [
    { id: 1, conversaId: 1, conteudo: 'OlÃ¡, gostaria de horÃ¡rios para hoje.', direcao: 'CLIENTE_PARA_EMPRESA', tipo: 'TEXTO', dataEnvio: '2026-06-16T08:55:00' },
    { id: 2, conversaId: 1, conteudo: 'Temos 09:00, 10:30 e 15:00 disponÃ­veis.', direcao: 'EMPRESA_PARA_CLIENTE', tipo: 'HORARIOS_DISPONIVEIS', dataEnvio: '2026-06-16T08:57:00' },
  ...
  pagamentos: [
    ...
    { id: 3, clienteId: 3, clienteNome: 'Kaito BistrÃ´', valor: 299.8, metodoPagamento: 'DINHEIRO', status: 'PAGO', dataPagamento: '2026-06-15T11:20:00' },
  ...
  entregas: [
    ...
    { id: 2, protocolo: 'BAK3744856', clienteId: 2, clienteNome: 'Nori Garden', responsavel: 'Caio Mendes', endereco: 'Av. JapÃ£o, 47', status: 'ENTREGUE', observacoes: 'Entrega concluÃ­da.', dataPrevisao: '2026-06-16', horaInicio: '18:00', horaFim: '19:00', total: 469.6 },
    { id: 3, protocolo: 'BAK260615A', clienteId: 3, clienteNome: 'Kaito BistrÃ´', responsavel: 'Marina Alves', endereco: 'Rua Central, 22', status: 'ENTREGUE', observacoes: 'ConfirmaÃ§Ã£o por e-mail.', dataPrevisao: '2026-06-16', horaInicio: '18:00', horaFim: '19:00', total: 299.8 },
  ],
  produtos: [
    ...
    { id: 3, nome: 'Headset Logitech H390', categoria: 'PerifÃ©rico', sku: 'ELE-HS-003', estoque: 25, valor: 219, status: 'ATIVO' },
  ...
  pedidos: [
    ...
    { id: 2, protocolo: 'PED-1002', clienteNome: 'Kaito BistrÃ´', produto: 'Monitor LG UltraWide 29"', valor: 1390, status: 'ENTREGA', data: '2026-06-15' },
